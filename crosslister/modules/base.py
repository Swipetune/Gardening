...
class ListingPayload(Dict[str, object]):
    ...
    def clone(self) -> "ListingPayload":
        """Return a deep copy of the payload."""

        return ListingPayload(copy.deepcopy(dict(self)))

    @property
    def images(self) -> List[str]:
        value = self.get("images", [])
    ...
    @property
    def shipping(self) -> Dict[str, object]:
        value = self.get("shipping", {})
        return value if isinstance(value, dict) else {}
